          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6">
                <img src="/images/icons/cbd_presence.png" alt="Premium Location" className="w-20 h-20 object-contain" />
              </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6">
                <img src="/images/icons/acra_registration.png" alt="ACRA Registration" className="w-20 h-20 object-contain" />
              </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
              <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6">
                <img src="/images/icons/privacy_protection.png" alt="Privacy Protection" className="w-20 h-20 object-contain" />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <img src="/images/icons/acra_registration.png" alt="ACRA Registration" className="w-24 h-24 object-contain" />
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <img src="/images/icons/home_based_business.png" alt="Home-Based Business" className="w-24 h-24 object-contain" />
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <img src="/images/icons/privacy_protection.png" alt="Privacy Protection" className="w-24 h-24 object-contain" />
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <img src="/images/icons/cbd_presence.png" alt="CBD Presence" className="w-24 h-24 object-contain" />
              </div>
